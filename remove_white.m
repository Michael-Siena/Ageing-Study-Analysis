...
raw_objects = 'D:\OneDrive - University Of Cambridge\Work\PhD Psychology\Experiment 4 - AnG and the Visual Perspective of Retrieval\Spatial Memory Task\OBJECTSALL\*.jpg';
objects_white_removed = 'D:\OneDrive - University Of Cambridge\Work\PhD Psychology\Experiment 4 - AnG and the Visual Perspective of Retrieval\Spatial Memory Task\Matlab\Output2';

filePattern = fullfile(raw_objects, '*.jpg*');
jpegFiles = dir(filePattern);

for k = 1:length(jpegFiles)
    baseFileName = jpegFiles(k).name;
    fullFileName = fullfile(raw_objects, baseFileName);
